...
|Latest Version|[![](https://img.shields.io/badge/version-0.4.1-brightgreen.svg)](https://github.com/neuropsychology/neuropsychology.R)|
...
- To get the latest development version (`0.4.1`), run the following:
